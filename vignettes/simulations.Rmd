...
ebc_tidy(detected, otus_da, m = length(otu_to_keep), measures = )
...
map_dfr(list(detected, detected_bh, c(), otu_to_keep), ebc_tidy, 
...
evabic:::area_rect(several_confint$FPR, several_confint$TPR)
```
