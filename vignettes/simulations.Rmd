...
round(data.frame(true = true_shifts, observed  = zscores,
      ...
      digits = 4)
x <- estimate_shifts2(rep(0, 8), zscores = zscores, tree = tree, lambda = 0.1, covar_mat = covar_mat)
x
unclass(x)
```
...
round(data.frame(true = true_shifts, observed  = zscores,
      ...
      digits = 4)
optimized
x <- estimate_shifts2(rep(0, 8), zscores = zscores, tree = tree, alpha = 1, lambda = 0.1)
x
plot(x)
```
